...
namespace TSMapEditor.UI
{
    public class KeyboardCommands
    {
        ...
        public KeyboardCommand PlaceTerrainLine { get; } = new KeyboardCommand("PlaceTerrainLine", Translate("KeyboardCommands.PlaceTerrainLine", "Place Terrain Line"), new KeyboardCommandInput(Keys.None, KeyboardModifiers.Shift), true);
